...
<head>
    ...
    <title>Buscar Coche por Modelo</title>
    <style>
        body {
            display: flex;
...
<body>
    <div class="form-container">
        <h1>Buscar Coche por Modelo</h1>
        
        <form action="resultados_busqueda3.php" method="post">
            <label for="modelo">Ingrese el modelo del coche:</label>
            <input type="text" id="modelo" name="modelo" placeholder="Ejemplo: Corolla, Mustang, Civic" required>
