...
$marca = trim(strip_tags($_REQUEST["marca"])); // Sanitizar la entrada
...
$sql = "SELECT * FROM coches WHERE marca LIKE '%$marca%'";
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<p>No se encontraron resultados para la marca '$marca'.</p>";
}
