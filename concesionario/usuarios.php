...
<div class="sidebar">
    ...
    <button class="option-button" onclick="location.href='modificar_usuario.php'">Modificar</button>
    <button class="option-button" onclick="location.href='eliminar_usuarios.php'">Borrar</button>
</div>

<div class="content">
    <p>¿Qué quiere hacer con los usuarios?</p>
</div>
